...
const NewStoryComponent = ({
  ...
  const handleSubmit = async () => {
    if (customFilter.isProfane(storyPrompt)) {
      alert(
        "Please remove any inappropriate language from your story prompt before submitting."
      );
      return;
    }
    setIsLoading(true);
  ...
  // Example prompts for the modal
  const examplePrompts = [
    "This tale begins in a quiet village where a young wizard discovers his powers.",
    "In a world where dragons rule the skies, a lone knight sets out on a quest.",
    "A group of friends stumbles upon an ancient map leading to forgotten treasure.",
    // ... other examples
  ];
          ...
          >
              ...
              <div className="grid grid-cols-3 gap-4">
                <div>
                  ...
                  <div className="flex gap-2">
                    {["6", "7", "8", "9", "10"].map((age) => (
                      <button
                        key={age}
                        className={`border-2 border-black w-12 h-12 btn btn-outline btn-secondary ${
                ...
                <div>
                  ...
                  <div className="flex gap-2">
                    {["English", "हिंदी", "عربي"].map((language) => (
                      <button
                        key={language}
                        className={`border-2 border-black px-4 py-2 btn btn-outline btn-secondary ${
                          selectedLanguage === language ? styles.selected : ""
                        }`}
                ...
                <div>
                  <label className="block mb-1">
                    Give us a glimpse into your story
                  </label>
                  <textarea
                    className="border-2 border-black w-full h-24 p-2"
                    placeholder="For eg. This story is about a boy named Esh, he's a wizard and doesn't know"
                    value={storyPrompt}
                    // onChange={(e) => {
                  ...
                  <ExamplesModal
                    ...
                    onSelect={handleExampleSelect} // Pass the function here
            ...
            <section className="mb-4">
              ...
              <div className="grid grid-cols-4 gap-4">
                {["Adventure", "Fantasy", "Mystery", "Action/Super-hero"].map(
                  (genre) => (
                    <button
                      key={genre}
                      className={`${
                        styles["genre-art-style"]
                  ...
                  (artStyle) => (
                    <button
                      ...
                      className={`${
                        ...
                        selectedArtStyle === artStyle ? styles.selected : ""
                      }`}
                    ...
                    >
                      <Image
                        src={
                          artStyleImages[
                            artStyle as keyof typeof artStyleImages
                          ]
                        }
